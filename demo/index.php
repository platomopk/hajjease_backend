<?php
    ...
    if(isset($_POST['submit'])){
        ...
        //check for retailers
        $query= mysqli_query($con,"SELECT id,name from usersw where email='$email' and password='$password'");
...
<html>
<head>
	<title>HajjEase - Official | Login </title>
                    ...
                    <div class="row" id="loginWrapper">
                        <div class="container" id="loginContainer">
                            <div class="row" id="loginBox">
                                <!-- login container -->
                                <div style="opacity:0.9;width: 350px;height: auto;margin:0px auto;border-radius: 10px;border-color: #e9e9e9; background-color:#e6e6e6;  border-width: 2px; border-style: solid;">
                                <!-- sms -->
                                <div style="padding:15px; padding-bottom:0px; color:#333; text-align: center;">
                                    <img style="height:50px;width:50px;" src="assets/mecca.png" alt="" srcset="">
                                </div>
                                <div style="padding:15px; padding-bottom:0px; color:#333; text-align: center;">
                                    <label style="font-weight: 100;font-size: 18px;    text-shadow: 0px 0px 6px #e6e6e6;">HAJJEASE - OFFICIAL</label>
                                </div>
                                <!-- email -->
                                ...
                                <!-- submit -->
                                <div style="padding:0px 15px 15px 15px">
                                    <input type="submit" name="submit" value="Log In" class="btn btn-primary" style="background-color:#5d99c6; border-color:#333; width: 100%">
                                </div>
                                <!-- forgot -->
