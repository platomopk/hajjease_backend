...
$query= mysqli_query($con,"Insert into servants (userId,fname,lname,mobile,landline,address,cnic,picture,gender,entryTime,exitTime,houseKeys,emptyHome,carKeys,driveAlone,isMonday,isTuesday,isWednesday,isThursday,isFriday,isSaturday,isSunday,type) values ('$userId','$first_name','$last_name','$cell','$landline','$address','$cnic','$path','$gender','$startTime','$endTime','$homekeys','$homealone','$carkeys','$drivealone','$monday','$tuesday','$wednesday','$thursday','$friday','$saturday','$sunday','$type')");
