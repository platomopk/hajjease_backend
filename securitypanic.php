...
"SELECT (SELECT concat(users.firstname,' ',users.lastname) FROM users WHERE users.userId=panic.userid) as name,
...
FROM panic WHERE panic.requesttime >= NOW() - INTERVAL 4 MINUTE ORDER BY panic.requesttime DESC
LIMIT 1");
