...
$query= mysqli_query($con,"Insert into complaints  
    (userId,category,title,message,status,closuretime,resource) values 
    ('$userId','$category','$title','$message','open',NOW() + INTERVAL 60 MINUTE,'1')");
